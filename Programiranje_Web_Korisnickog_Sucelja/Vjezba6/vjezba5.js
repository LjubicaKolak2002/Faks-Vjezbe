...
let result1 = returnCountries(countries);
console.log(result1);


//3.zadatak
let returnEuropeanCountries = (countries) =>
    countries.filter(country => country.region === "Europe");

let result2 = returnCountries(returnEuropeanCountries(countries));
console.log(result2);


//4.zadatak
const europeCountries = returnEuropeanCountries(countries).map(element => element.area);
//console.log(europeCountries);

let returnAllArea = (europeCountries) =>
    europeCountries.reduce((first, second) => first + second, 0);

let result3 = returnAllArea(europeCountries);
console.log(result3);


//5.zadatak
let returnCountryOfCity = (countries) =>
   (countries.find(city => city.capital[0] === "Pyongyang")) ? (countries.find(city => city.capital[0] === "Pyongyang").name.common): null;

let result4 = returnCountryOfCity(countries);
console.log(result4);
